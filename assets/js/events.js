...
// remove the page checker conditional from each of these three JavaScript files and replace it with the DOM ready method, which will then wrap the DOM manipulation just as the conditional statements had done
